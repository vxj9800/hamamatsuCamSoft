...
#include			"dcamprop.h"
#else
#include			"../dcamsdk4/inc/dcamapi4.h"
#include			"../dcamsdk4/inc/dcamprop.h"
#endif

// // Following is turned off since the library is being added manually to the compilation process and following lines hinder with it.
// #if defined(_WIN64)
// #pragma comment(lib,"../dcamsdk4/lib/win64/dcamapi.lib")
// #elif defined(WIN32)
// #pragma comment(lib,"../dcamsdk4/lib/win32/dcamapi.lib")
// #endif
